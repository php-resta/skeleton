...
class Cancel_update extends ClientProvider implements ClientContract
{
    //request and request generator
    use Client,Cancel_updateGenerator,ClientGenerator,CancelTrait;

    /**
     * @var string
     */
    public $clientName = 'Cancel_update_client';
     ...
     * @var array
     */
    protected $expected = ["order_cancel_code"];
